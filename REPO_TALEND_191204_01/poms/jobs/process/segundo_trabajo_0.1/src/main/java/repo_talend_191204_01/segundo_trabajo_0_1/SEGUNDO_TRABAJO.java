...
package repo_talend_191204_01.segundo_trabajo_0_1;
...
/**
 * Job: SEGUNDO_TRABAJO Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 7.2.1.20190909_1200_patch
 * @status 
 */
public class SEGUNDO_TRABAJO implements TalendJob {
	static {System.setProperty("TalendJob.log", "SEGUNDO_TRABAJO.log");}
	private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(SEGUNDO_TRABAJO.class);
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "SEGUNDO_TRABAJO";
...
private RunStat runStat = new RunStat();
	...
	JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_9sPkQBaWEeqLAaA8xT5yPw", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				SEGUNDO_TRABAJO.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(SEGUNDO_TRABAJO.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_REPO_TALEND_191204_01_SEGUNDO_TRABAJO = new byte[0];
    static byte[] commonByteArray_REPO_TALEND_191204_01_SEGUNDO_TRABAJO = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_REPO_TALEND_191204_01_SEGUNDO_TRABAJO.length) {
				if(length < 1024 && commonByteArray_REPO_TALEND_191204_01_SEGUNDO_TRABAJO.length == 0) {
   					commonByteArray_REPO_TALEND_191204_01_SEGUNDO_TRABAJO = new byte[1024];
				} else {
   					commonByteArray_REPO_TALEND_191204_01_SEGUNDO_TRABAJO = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_REPO_TALEND_191204_01_SEGUNDO_TRABAJO, 0, length);
			strReturn = new String(commonByteArray_REPO_TALEND_191204_01_SEGUNDO_TRABAJO, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_REPO_TALEND_191204_01_SEGUNDO_TRABAJO) {
 ...
 */
    ...
    public static void main(String[] args){
        final SEGUNDO_TRABAJO SEGUNDO_TRABAJOClass = new SEGUNDO_TRABAJO();

        int exitCode = SEGUNDO_TRABAJOClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'SEGUNDO_TRABAJO' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        for (String arg : args) {
        	...
        	log.info("TalendJob: 'SEGUNDO_TRABAJO' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = SEGUNDO_TRABAJO.class.getClassLoader().getResourceAsStream("repo_talend_191204_01/segundo_trabajo_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = SEGUNDO_TRABAJO.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : SEGUNDO_TRABAJO");
        }
		if(enableLogStash) {
...
/************************************************************************************************
 *     44403 characters generated by Talend Cloud Big Data 
 *     on the 4 de diciembre de 2019 16:12:08 CET
 ************************************************************************************************/