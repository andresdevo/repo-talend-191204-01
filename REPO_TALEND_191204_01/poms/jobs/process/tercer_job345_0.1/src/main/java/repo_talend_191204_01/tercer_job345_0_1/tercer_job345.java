...
package repo_talend_191204_01.tercer_job345_0_1;
...
/**
 * Job: tercer_job345 Purpose: <br>
 * Description:  <br>
 * @author andres.torres.mendoza@devoteam.com
 * @version 7.2.1.20190909_1200_patch
 * @status 
 */
public class tercer_job345 implements TalendJob {
	static {System.setProperty("TalendJob.log", "tercer_job345.log");}
	private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(tercer_job345.class);
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "tercer_job345";
...
private RunStat runStat = new RunStat();
	...
	JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_jUqFIBaZEeqcROoZHQkefA", "0.1");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				tercer_job345.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(tercer_job345.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_REPO_TALEND_191204_01_tercer_job345 = new byte[0];
    static byte[] commonByteArray_REPO_TALEND_191204_01_tercer_job345 = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_REPO_TALEND_191204_01_tercer_job345.length) {
				if(length < 1024 && commonByteArray_REPO_TALEND_191204_01_tercer_job345.length == 0) {
   					commonByteArray_REPO_TALEND_191204_01_tercer_job345 = new byte[1024];
				} else {
   					commonByteArray_REPO_TALEND_191204_01_tercer_job345 = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_REPO_TALEND_191204_01_tercer_job345, 0, length);
			strReturn = new String(commonByteArray_REPO_TALEND_191204_01_tercer_job345, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_REPO_TALEND_191204_01_tercer_job345) {
 ...
 */
    ...
    public static void main(String[] args){
        final tercer_job345 tercer_job345Class = new tercer_job345();

        int exitCode = tercer_job345Class.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'tercer_job345' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        for (String arg : args) {
        	...
        	log.info("TalendJob: 'tercer_job345' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = tercer_job345.class.getClassLoader().getResourceAsStream("repo_talend_191204_01/tercer_job345_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = tercer_job345.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : tercer_job345");
        }
		if(enableLogStash) {
...
/************************************************************************************************
 *     44379 characters generated by Talend Cloud Big Data 
 *     on the 4 de diciembre de 2019 16:12:10 CET
 ************************************************************************************************/