...
public class primerjob implements TalendJob {
	static {System.setProperty("TalendJob.log", "primerjob.log");}
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = primerjob.class.getClassLoader().getResourceAsStream("repo_talend_191204_01/primerjob_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = primerjob.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
try {
errorCode = null;tFixedFlowInput_2Process(globalMap);
...
/************************************************************************************************
 *     44274 characters generated by Talend Cloud Big Data 
 *     on the 4 de diciembre de 2019 18:33:11 CET
 ************************************************************************************************/