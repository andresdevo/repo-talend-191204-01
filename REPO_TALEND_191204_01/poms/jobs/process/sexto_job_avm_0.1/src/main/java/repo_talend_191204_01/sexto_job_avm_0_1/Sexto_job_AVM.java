...
package repo_talend_191204_01.sexto_job_avm_0_1;
 ...
 * @status
 */
public class Sexto_job_AVM implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "Sexto_job_AVM.log");
	}
	private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(Sexto_job_AVM.class);
	...
	private final String jobName = "Sexto_job_AVM";
	...
	JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_A8txUBapEeqQdJuFqBSHSg", "0.1");
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Sexto_job_AVM.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Sexto_job_AVM.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_REPO_TALEND_191204_01_Sexto_job_AVM = new byte[0];
		static byte[] commonByteArray_REPO_TALEND_191204_01_Sexto_job_AVM = new byte[0];

		public String campo_str;

		public String getCampo_str() {
			return this.campo_str;
		}
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_REPO_TALEND_191204_01_Sexto_job_AVM.length) {
					if (length < 1024 && commonByteArray_REPO_TALEND_191204_01_Sexto_job_AVM.length == 0) {
						commonByteArray_REPO_TALEND_191204_01_Sexto_job_AVM = new byte[1024];
					} else {
						commonByteArray_REPO_TALEND_191204_01_Sexto_job_AVM = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_REPO_TALEND_191204_01_Sexto_job_AVM, 0, length);
				strReturn = new String(commonByteArray_REPO_TALEND_191204_01_Sexto_job_AVM, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_REPO_TALEND_191204_01_Sexto_job_AVM) {

				try {

					int length = 0;

					this.campo_str = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.campo_str, dos);
...
///////////////////////    			
				...
				for (int i_tFixedFlowInput_1 = 0; i_tFixedFlowInput_1 < 1; i_tFixedFlowInput_1++) {
					...
					row1.campo_str = "sexto job by AVM";
...
///////////////////////		
					...
					if (row1.campo_str != null) { //

						strBuffer_tLogRow_1.append(String.valueOf(row1.campo_str));
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final Sexto_job_AVM Sexto_job_AVMClass = new Sexto_job_AVM();

		int exitCode = Sexto_job_AVMClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'Sexto_job_AVM' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		log.info("TalendJob: 'Sexto_job_AVM' - Start.");
		...
		try {
			...
			java.io.InputStream inContext = Sexto_job_AVM.class.getClassLoader().getResourceAsStream(
					"repo_talend_191204_01/sexto_job_avm_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Sexto_job_AVM.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Sexto_job_AVM");
		}
		if (enableLogStash) {
...
/************************************************************************************************
 * 44412 characters generated by Talend Cloud Big Data on the 4 de diciembre de
 * 2019 16:17:10 CET
 ************************************************************************************************/