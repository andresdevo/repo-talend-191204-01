...
package repo_talend_191204_01.cuarto_o_0_1;
...
/**
 * Job: CUARTO_O Purpose: <br>
 * Description:  <br>
 * @author andres.torres.mendoza@devoteam.com
 * @version 7.2.1.20190909_1200_patch
 * @status 
 */
public class CUARTO_O implements TalendJob {
	static {System.setProperty("TalendJob.log", "CUARTO_O.log");}
	private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(CUARTO_O.class);
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "CUARTO_O";
...
private RunStat runStat = new RunStat();
	...
	JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_5MkEMBanEeqzlMIl55-7rQ", "0.1");
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(CUARTO_O.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
	...
	Object obj_tRunJob_1 = null;
	    ...
	    if (null != talendDataSources_tRunJob_1) {
			...
			log.info("tRunJob_1 - The child job 'repo_talend_191204_01.primerjob_0_1.primerjob' starts on the version '0.1' with the context 'Default'.");
                ...
                class BytesLimit65535_tRunJob_3{
                    ...
                    log4jParamters_tRunJob_3.append("Parameters:");
                        ...
                        log4jParamters_tRunJob_3.append(" | ");
                            log4jParamters_tRunJob_3.append("PROCESS" + " = " + "SEGUNDO_TRABAJO");
                        log4jParamters_tRunJob_3.append(" | ");
 ...
 */
	...
	Object obj_tRunJob_3 = null;
		...
		repo_talend_191204_01.segundo_trabajo_0_1.SEGUNDO_TRABAJO childJob_tRunJob_3 = new repo_talend_191204_01.segundo_trabajo_0_1.SEGUNDO_TRABAJO();
	    // pass DataSources
	    ...
	    if (null != talendDataSources_tRunJob_3) {
			...
			log.info("tRunJob_3 - The child job 'repo_talend_191204_01.segundo_trabajo_0_1.SEGUNDO_TRABAJO' starts on the version '0.1' with the context 'Default'.");
		...
		String[][] childReturn_tRunJob_3 = childJob_tRunJob_3.runJob((String[]) paraList_tRunJob_3.toArray(new String[paraList_tRunJob_3.size()]));
			...
			log.info("tRunJob_3 - The child job 'repo_talend_191204_01.segundo_trabajo_0_1.SEGUNDO_TRABAJO' is done.");
                ...
                class BytesLimit65535_tRunJob_6{
                    ...
                    log4jParamters_tRunJob_6.append("Parameters:");
                        ...
                        log4jParamters_tRunJob_6.append(" | ");
                            log4jParamters_tRunJob_6.append("PROCESS" + " = " + "tercer_job345");
                        log4jParamters_tRunJob_6.append(" | ");
 ...
 */
	...
	Object obj_tRunJob_6 = null;
		...
		repo_talend_191204_01.tercer_job345_0_1.tercer_job345 childJob_tRunJob_6 = new repo_talend_191204_01.tercer_job345_0_1.tercer_job345();
	    // pass DataSources
	    ...
	    if (null != talendDataSources_tRunJob_6) {
			...
			log.info("tRunJob_6 - The child job 'repo_talend_191204_01.tercer_job345_0_1.tercer_job345' starts on the version '0.1' with the context 'Default'.");
		...
		String[][] childReturn_tRunJob_6 = childJob_tRunJob_6.runJob((String[]) paraList_tRunJob_6.toArray(new String[paraList_tRunJob_6.size()]));
			...
			log.info("tRunJob_6 - The child job 'repo_talend_191204_01.tercer_job345_0_1.tercer_job345' is done.");
 ...
 */
    ...
    public static void main(String[] args){
        final CUARTO_O CUARTO_OClass = new CUARTO_O();

        int exitCode = CUARTO_OClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'CUARTO_O' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        for (String arg : args) {
        	...
        	log.info("TalendJob: 'CUARTO_O' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = CUARTO_O.class.getClassLoader().getResourceAsStream("repo_talend_191204_01/cuarto_o_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = CUARTO_O.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : CUARTO_O");
        }
		if(enableLogStash) {
...
/************************************************************************************************
 *     58143 characters generated by Talend Cloud Big Data 
 *     on the 4 de diciembre de 2019 18:33:14 CET
 ************************************************************************************************/