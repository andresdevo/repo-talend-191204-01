...
public class CUARTO_O implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "CUARTO_O.log");
	}
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				log.info(
						"tRunJob_3 - The child job 'repo_talend_191204_01.segundo_trabajo_0_1.SEGUNDO_TRABAJO' starts on the version '0.1' with the context 'Default'.");
				...
				log.info(
						"tRunJob_3 - The child job 'repo_talend_191204_01.segundo_trabajo_0_1.SEGUNDO_TRABAJO' is done.");
	...
	public void tRunJob_6Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				log.info(
						"tRunJob_6 - The child job 'repo_talend_191204_01.tercer_job345_0_1.tercer_job345' starts on the version '0.1' with the context 'Default'.");
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = CUARTO_O.class.getClassLoader()
					.getResourceAsStream("repo_talend_191204_01/cuarto_o_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = CUARTO_O.class.getClassLoader()
...
/************************************************************************************************
 * 58143 characters generated by Talend Cloud Big Data on the 4 de diciembre de
 * 2019 16:12:12 CET
 ************************************************************************************************/